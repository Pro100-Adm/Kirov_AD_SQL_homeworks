...
UPDATE media
SET created_at = "1970-01-18 03:54:01"
WHERE id = 1;
UPDATE media
SET created_at = "1970-11-18 03:54:01"
WHERE id = 2;
UPDATE media
SET created_at = "1970-12-18 03:54:01"
WHERE id = 3;
UPDATE media
SET created_at = "1970-10-18 03:54:01"
WHERE id = 3;
...
FROM media
WHERE filename LIKE "%docx" OR filename LIKE "%doc" OR filename LIKE "%html"
GROUP BY user_id;
